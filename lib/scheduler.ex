defmodule Scheduler do
  ...
  def tasks do
    [
      %Todo{id: 1, name: "CS280: Test Section 5", weight: 180, priority: 400},
      %Todo{id: 2, name: "CS210: Finish Week #1 HW", weight: 180, priority: 400},
      %Todo{id: 3, name: "Feed Hiro water", weight: 5, priority: 100},
      %Todo{id: 4, name: "Write TP #1", weight: 180, priority: 400},
      %Todo{id: 5, name: "CS280: Study week topic", weight: 240, priority: 400},
      %Todo{id: 6, name: "Study Haskell", weight: 120, priority: 200},
      %Todo{id: 7, name: "Write TP #2", weight: 180, priority: 300},
      %Todo{id: 8, name: "Read Pragmatic Programmer Book", weight: 60, priority: 400},
      %Todo{id: 9, name: "Sound the horn", weight: 1, priority: 100},
      %Todo{id: 10, name: "CS210: Prepare for final project", weight: 180, priority: 100}
    ]
  end
